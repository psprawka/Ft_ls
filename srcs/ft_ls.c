...
/*   Updated: 2020/03/28 18:24:19 by psprawka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			main(int ac, char **av)
{
	...
	{
		tmp_data = tmp->data;
		if ((info.args_nb > 1 || FLAG_R & info.flags) && !(info.args_nb == info.left_args_nb && FLAG_R & info.flags) && info.args_nb != info.left_args_nb)
			printf("\n");
